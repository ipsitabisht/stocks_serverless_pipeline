...
The Stock Mover App displays the top moving tickers of the week (by % change) according to open/close dates. This project was created using a variety of AWS Resources and frontend technologies, all deployed using Terraform and Github Actions 
